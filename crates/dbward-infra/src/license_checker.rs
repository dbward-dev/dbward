...
impl LicenseChecker for LicenseCheckerImpl {
    fn max_tokens(&self) -> u32 {
        self.license.limits().map_or(u32::MAX, |l| l.max_tokens as u32)
    }

    fn max_workflows(&self) -> u32 {
        self.license.limits().map_or(u32::MAX, |l| l.max_workflows as u32)
    }

    fn max_webhooks(&self) -> u32 {
        self.license.limits().map_or(u32::MAX, |l| l.max_webhooks as u32)
    }
