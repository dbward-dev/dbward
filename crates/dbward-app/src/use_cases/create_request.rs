...
mod tests {
    ...
    impl RequestRepo for FakeRequestRepo {
        ...
        fn approve_and_mark_approved(&self, _: &dbward_domain::entities::Approval, _: &str, _: chrono::DateTime<chrono::Utc>, _: &dbward_domain::entities::AuditEvent) -> Result<bool, AppError> { Ok(true) }
        fn mark_rejected(&self, _: &str, _: chrono::DateTime<chrono::Utc>) -> Result<bool, AppError> { Ok(true) }
        fn reject_and_record(&self, _: &str, _: &dbward_domain::entities::Approval, _: chrono::DateTime<chrono::Utc>, _: &dbward_domain::entities::AuditEvent) -> Result<bool, AppError> { Ok(true) }
