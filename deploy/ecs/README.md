...
aws cloudformation deploy --stack-name dbward-agent --template-file agent.yaml \
  --parameter-overrides \
    ClusterName=$CLUSTER \
    VpcId=vpc-xxx \
    SubnetIds=subnet-aaa \
...
aws cloudformation deploy --stack-name dbward-storage --template-file storage.yaml \
